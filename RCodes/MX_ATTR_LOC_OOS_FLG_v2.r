...
options(scipen=999)
windows.oos.ads = "C:\\Users\\abhishek.meena\\Desktop\\IM\\MAX_LDS_R_PROJECT\\DATASD_MAX_LNG_OOS_FLG_ADS.txt"
...
write.table(EXPORT_OOS_FLG,"C:/Users/abhishek.meena/Desktop/IM/MAX_LDS_R_PROJECT/DATA/SD_MAX_CLN_OOS_FLG_ADS.csv", sep=",", row.names=FALSE)
write.table(FINAL_OOS_SUMMARY,"C:/Users/abhishek.meena/Desktop/IM/MAX_LDS_R_PROJECT/DATA/SD_MAX_CLN_OOS_SMRY.csv", sep=",", row.names=FALSE)
write.table(EXPORT_OOS_FLG,"C:/Users/abhishek.meena/Desktop/IM/MAX_LDS_R_PROJECT/DATA/SD_MAX_CLN_OOS_FLG_ADS.csv", sep=",", row.names=FALSE)
write.table(FINAL_OOS_SUMMARY,"C:/Users/abhishek.meena/Desktop/IM/MAX_LDS_R_PROJECT/DATA/SD_MAX_CLN_OOS_SMRY.csv", sep=",", row.names=FALSE)
